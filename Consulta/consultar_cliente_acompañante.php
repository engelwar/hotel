...
<div class="p-5">
  ...
  if (isset($_GET['ci']) && $_GET['ci'] != null) {
    ...
    $sqlCliente   = ("
    SELECT 
    cliente.nombres AS nomC,
    cliente.apellidos AS apeC,
    cliente.carnet AS ciC,
    cliente.celular,
    acompañante.nombres,
    acompañante.apellidos,
    acompañante.carnet
    FROM cliente 
    JOIN acompañante ON acompañante.codigo_cliente = cliente.codigo_cliente 
    WHERE carnet = '" . $ci . "' 
    ");
                    ...
                    <table class="table table-bordered table-striped table-hover">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Nom_Acompañante</th>
                          <th scope="col">Ape_Acompañante</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                        while ($dataCliente = mysqli_fetch_array($queryCliente)) { ?>
                          <tr>
                            <td><?php echo $dataCliente['nomC']; ?></td>
                            <td><?php echo $dataCliente['apeC']; ?></td>
                            <td><?php echo $dataCliente['ciC']; ?></td>
