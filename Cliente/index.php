...
<div class="p-5">
  ...
  if (isset($_GET['ci']) && $_GET['ci'] != null) {
    ...
    $sqlCliente   = ("SELECT * FROM cliente where carnet = '" . $ci . "' ");
    $queryCliente = mysqli_query($con, $sqlCliente);
    $cantidad     = mysqli_num_rows($queryCliente);
  } else {
    $sqlCliente   = ("SELECT * FROM cliente ORDER BY codigo_cliente  DESC ");
    $queryCliente = mysqli_query($con, $sqlCliente);
    $cantidad     = mysqli_num_rows($queryCliente);
  }
                      ...
                      <tbody>
                        ...
                        while ($dataCliente = mysqli_fetch_array($queryCliente)) { ?>
                          <tr>
                            ...
                            <td>
                              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteChildresn<?php echo $dataCliente['codigo_cliente']; ?>">
                              ...
                              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editChildresn<?php echo $dataCliente['codigo_cliente']; ?>">
